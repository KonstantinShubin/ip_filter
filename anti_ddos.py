...
def check_ip(our_ip):
    ...
    if ip_filter_table[our_ip]["STATUS"] == 1:
        if ip_filter_table[our_ip]["BANNED_TIME"] == 0 and login_time - ip_filter_table[our_ip]["TIME"] > log_time:
            ip_filter_table[our_ip]["STATUS"] = 0
            ip_filter_table[our_ip]["TIME"] = login_time
            return OK, ""
        elif ip_filter_table["BANNED_TIME"] > login_time - ip_filter_table[our_ip]["TIME"]:
            ip_filter_table[our_ip]["TIME"] = login_time
            ip_filter_table[our_ip]["BANNED_TIME"] = ban_time_coef * (ip_filter_table[our_ip]["BANNED_TIME"] - login_time - ip_filter_table[our_ip]["TIME"])
    ...
    elif ip_filter_table[our_ip]["NUM_LOGINS"] + 1 > num_softban:
        ...
        if login_time - ip_filter_table[our_ip]["TIME"] > log_time:
